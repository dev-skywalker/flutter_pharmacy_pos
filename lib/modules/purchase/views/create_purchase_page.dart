...
import 'package:pharmacy_pos/modules/payment_type/model/payment_type_model.dart';
...
class CreatePurchasePage extends GetView<PurchaseController> {
        ...
        actions: [
          TextButton.icon(
            onPressed: () {
              ...
              if (isValidate) {
                controller.createPurchaseWithItem();
              }
