...
class CreatePurchaseReturnPage extends GetView<PurchaseController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            onPressed: () {
              bool isValidate =
                  controller.createPurchaseFormKey.currentState!.validate();
              if (isValidate) {
                controller.createPurchaseReturnWithItems(int.parse(id));
              }
              //print(controller.purchaseDate.toIso8601String());
            },
      ...
      body: _createPurchaseWidget(context, isSmallScreen),
    );
  }

  Widget _createPurchaseWidget(BuildContext context, bool isSmallScreen) {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Form(
          key: controller.createPurchaseFormKey,
          child: Column(
            children: [
              ResponsiveGridRow(
                children: [
                                                ...
                                                TextButton(
                                                    onPressed: () {
                                                      if (controller
                                                        ...
                                                        // Reassign the modified item to trigger a UI update
                                                        controller.purchaseItemList[index] = PurchaseItemModel(
                                                            productName: controller
                                                                .purchaseItemList[
                                                                    index]
                                                                .productName,
