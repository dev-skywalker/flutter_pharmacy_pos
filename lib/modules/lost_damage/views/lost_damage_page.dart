...
class LostDamagePage extends StatefulWidget {
  const LostDamagePage({super.key});

  @override
  LostDamagePageState createState() => LostDamagePageState();
}

class LostDamagePageState extends State<LostDamagePage> {
  final int _rowsPerPage = PaginatedDataTable.defaultRowsPerPage;
  bool _sortAscending = true;
  int? _sortColumnIndex;
  LostDamageDataSourceAsync? _dessertsDataSource;
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      Get.toNamed(
                          '${Routes.app}${Routes.lostDamage}${Routes.create}');
                    },
                    child: Container(
                      //height: 42,
                      // width: 120,
                      ...
                      child: Center(
                        child: Text(
                          isSmallScreen ? "Create LostDamage" : "Create",
