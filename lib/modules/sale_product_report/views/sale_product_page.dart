...
import 'package:pharmacy_pos/modules/sale_product_report/services/sale_product_service.dart';
...
class SaleProductPage extends StatefulWidget {
  ...
  @override
  SaleProductPageState createState() => SaleProductPageState();
}

class SaleProductPageState extends State<SaleProductPage> {
  final int _rowsPerPage = PaginatedDataTable.defaultRowsPerPage;
  bool _sortAscending = true;
  int? _sortColumnIndex;
  SaleProductDataSourceAsync? _dessertsDataSource;
  ...
  void _getSaleTotal() async {
    ...
    final saleService = SaleProductService();
    final res = await saleService.getSaleProductTotal(
            ...
            ResponsiveGridRow(children: [
              ResponsiveGridCol(
                ...
                child: AmountCard(
                    ...
                    title: "${response?['totalSalesAmount'] ?? 0}",
              ...
              ResponsiveGridCol(
                ...
                child: AmountCard(
                    ...
                    icon: Icons.percent,
                    title: "${response?['totalTaxAmount'] ?? 0}",
              ...
              ResponsiveGridCol(
                ...
                child: AmountCard(
                    ...
                    icon: Icons.discount,
                    title: "${response?['totalDiscountAmount'] ?? 0}",
              ...
              ResponsiveGridCol(
                ...
                child: AmountCard(
                    ...
                    title: "${response?['totalQuantitySold'] ?? 0}",
                    subTitle: "Total Qty Sold"),
              ),
              ResponsiveGridCol(
                sm: 12,
                md: 6,
                ...
                child: AmountCard(
                    ...
                    title: "${response?['totalProfit'] ?? 0}",
                    subTitle: "Total Sale Profit"),
                // child: Card(
