...
class StockAlertPage extends StatefulWidget {
  ...
  @override
  StockAlertPageState createState() => StockAlertPageState();
}

class StockAlertPageState extends State<StockAlertPage> {
  final int _rowsPerPage = PaginatedDataTable.defaultRowsPerPage;
  bool _sortAscending = true;
  int? _sortColumnIndex;
  StockAlertDataSourceAsync? _dessertsDataSource;
