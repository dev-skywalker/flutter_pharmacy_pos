...
class CreateSalesPage extends GetView<SalesController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Create New Sales"),
        centerTitle: false,
        leading: IconButton(
          onPressed: () {
        ...
        actions: [
          TextButton.icon(
            onPressed: () {
              ...
              if (isValidate) {
                controller.createSalesWithItem();
              }
      ...
      body: _createSalesWidget(context, isSmallScreen),
    );
  }

  Widget _createSalesWidget(BuildContext context, bool isSmallScreen) {
                    ...
                    Obx(() {
                      ...
                      return Column(
                        children: [
                                              ...
                                              children: [
                                                ...
                                                TextButton(
                                                    onPressed: () {
                                                      ...
                                                      // Reassign the modified item to trigger a UI update
                                                      controller.salesItemList[index] = SalesItemModel(
                                                          productName: controller
                                                              .salesItemList[
                                                                  index]
                                                              .productName,
                          ...
                          Center(
                              child: controller.salesItemList.isEmpty
                                  ? const Padding(
                                      padding:
