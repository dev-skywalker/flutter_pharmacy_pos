...
class CustomerPageState extends State<CustomerPage> {
  ...
  CustomerDataSourceAsync? _dessertsDataSource;
            ...
            child: Row(
              children: [
                ...
                SizedBox(
                  ...
                  child: InkWell(
                    onTap: () async {
                      final gotoCreateCustomer = await Get.toNamed(
                          '${Routes.app}${Routes.customers}${Routes.create}');
                      if (gotoCreateCustomer.toString() == "back") {
                        print("it Workk");
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          isSmallScreen ? "Create Customer" : "Create",
