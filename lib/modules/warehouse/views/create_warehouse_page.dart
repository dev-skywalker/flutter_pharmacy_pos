...
class CreateWarehousePage extends GetView<WarehouseController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            onPressed: () {
              bool isValidate =
                  controller.createWarehouseFormKey.currentState!.validate();
              if (isValidate) {
      ...
      body: _createWarehouseWidget(),
    );
  }

  Widget _createWarehouseWidget() {
    return SingleChildScrollView(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Form(
            key: controller.createWarehouseFormKey,
            child: Column(
              children: [
                Column(
