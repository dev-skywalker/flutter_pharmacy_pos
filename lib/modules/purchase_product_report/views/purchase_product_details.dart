...
class PurchaseProductDetailsPage extends GetView<PurchaseProductController> {
  const PurchaseProductDetailsPage({super.key});
        ...
        leading: IconButton(
          onPressed: () {
            Get.rootController.rootDelegate.canBack
                ? Get.back()
                : Get.offAllNamed('${Routes.app}${Routes.purchaseProduct}');
          },
