...
class PurchaseReturnPageState extends State<PurchaseReturnPage> {
  ...
  PurchaseReturnDataSourceAsync? _dessertsDataSource;
          ...
          SizedBox(
            ...
            child: Row(
              children: [
                Flexible(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: "Search PurchaseReturn",
                        suffix: IconButton(
                            iconSize: 16,
                            color: Colors.red,
                ...
                //     onTap: () {
                //       // Get.toNamed(
                //       //     '${Routes.app}${Routes.purchaseReturn}${Routes.create}');
                //     },
                //     child: Container(
                //       //height: 42,
                //       // width: 120,
                ...
                //       child: Center(
                //         child: Text(
                //           isSmallScreen ? "Create PurchaseReturn" : "Create",
